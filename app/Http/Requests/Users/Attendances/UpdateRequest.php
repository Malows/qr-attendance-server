...
class UpdateRequest extends FormRequest
{
    ...
    {
        // Get the attendance from route
        $attendance = $this->route('attendance');

        // Check if user can update this specific attendance
        // This verifies permission and ownership through the policy
    ...
    {
        return [
            'check_in.required' => 'La hora de entrada es obligatoria cuando se proporciona.',
